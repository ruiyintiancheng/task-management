<template lang="html">
  <div class="cron">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane v-if="paramData.defType === '1'" label="Cron表达式" name="cron">
        <div :val="value_">
      ...
      <el-tab-pane v-if="paramData.defType === '2'" label="Simp表达式" name="simp">
        <div :val="simp_">
          <!-- <div class="pd-bottom">
            开始时间：<el-date-picker v-model="startDate" type="datetime" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
          </div>
          <div class="pd-bottom">
            结束时间：<el-date-picker v-model="endDate" type="datetime" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
          </div> -->
          <div class="pd-bottom">
    ...
    <!-- table -->
    <el-table v-if="paramData.defType === '1'"
       v-show="showTable"
       :data="tableData"
       size="mini"
       border
     ...
     <div style="text-align:left;padding-top:3px;"  v-if="paramData.defType === '1' || paramData.defType === '2'">
...
export default {
  ...
  computed: {
    ...
    simp_() {
      const s = `${this.paramData.startTime}/${this.paramData.endTime}/${this.repeatTime}/${this.repeatSpace}`
      this.simpExpress = s
      return s
    }
  },
  ...
  methods: {
    ...
    setSimpVal(val) {
      ...
      const arrays = val.split('/')
      // this.startDate = arrays[0]
      // this.endDate = arrays[1]
